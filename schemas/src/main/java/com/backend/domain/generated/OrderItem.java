...
public class OrderItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7385944275428298628L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderItem\",\"namespace\":\"com.backend.domain.generated\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"size\",\"type\":{\"type\":\"enum\",\"name\":\"Size\",\"symbols\":[\"SMALL\",\"MEDIUM\",\"LARGE\"]}},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"cost\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":3,\"scale\":2}}]}");
...
static {
  ...
  @Deprecated public com.backend.domain.generated.Size size;
   ...
   */
  public OrderItem(java.lang.CharSequence name, com.backend.domain.generated.Size size, java.lang.Integer quantity, java.math.BigDecimal cost) {
    this.name = name;
    this.size = size;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: size = (com.backend.domain.generated.Size)value$; break;
   ...
   */
  public com.backend.domain.generated.Size getSize() {
    return size;
  }
   ...
   * @param value the value to set.
   */
  public void setSize(com.backend.domain.generated.Size value) {
    this.size = value;
  }
   ...
   */
  public static com.backend.domain.generated.OrderItem.Builder newBuilder() {
    return new com.backend.domain.generated.OrderItem.Builder();
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.backend.domain.generated.OrderItem.Builder newBuilder(com.backend.domain.generated.OrderItem.Builder other) {
    if (other == null) {
      return new com.backend.domain.generated.OrderItem.Builder();
    } else {
      return new com.backend.domain.generated.OrderItem.Builder(other);
    }
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.backend.domain.generated.OrderItem.Builder newBuilder(com.backend.domain.generated.OrderItem other) {
    if (other == null) {
      return new com.backend.domain.generated.OrderItem.Builder();
    } else {
      return new com.backend.domain.generated.OrderItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderItem>
    ...
    private com.backend.domain.generated.Size size;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.backend.domain.generated.OrderItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.backend.domain.generated.OrderItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.domain.generated.OrderItem.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.domain.generated.OrderItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.domain.generated.OrderItem.Builder setSize(com.backend.domain.generated.Size value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.domain.generated.OrderItem.Builder clearSize() {
      size = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.domain.generated.OrderItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.domain.generated.OrderItem.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.domain.generated.OrderItem.Builder setCost(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.backend.domain.generated.OrderItem.Builder clearCost() {
      cost = null;
    ...
    public OrderItem build() {
      try {
        ...
        record.size = fieldSetFlags()[1] ? this.size : (com.backend.domain.generated.Size) defaultValue(fields()[1]);
